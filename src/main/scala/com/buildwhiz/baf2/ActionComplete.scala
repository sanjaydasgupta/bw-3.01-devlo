...
//          val parentProcess: DynDoc = ActivityApi.parentProcess(theActivity._id[ObjectId])
//          val bpmnName = theActivity.bpmn_name[String]
//          val topBpmnName = parentProcess.bpmn_name[String]
//          val allProcessesComplete = parentProcess.bpmn_timestamps[Many[Document]].
...
//            true
//          else
//            parentProcess.bpmn_timestamps[Many[Document]].
...
//          }
      ...
      val message = s"Completed action '$actionName'"
