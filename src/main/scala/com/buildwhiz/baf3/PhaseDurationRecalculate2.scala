...
class PhaseDurationRecalculate2 extends HttpServlet with HttpUtils {
  override def doPost(request: HttpServletRequest, response: HttpServletResponse): Unit = {
    ...
    try {
      ...
      val phaseDuration = ProcessBpmnTraverse2.processDurationRecalculate(bpmnName, phaseOid, oidAndDurations, request)
