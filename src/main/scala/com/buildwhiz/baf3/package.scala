...
package object baf3 {
  ...
  private val menuItemsList: Seq[Document] = Seq(
    ...
    Map("access" -> "*", "navIcon" -> "assets/images/teenyicons/outline-white/layers.svg",
      ...
      "navLabel" -> "Phase", "routeUrl" -> "/private/phases/phase-details", "toolTipLabel" -> "Phase"),
    Map("access" -> "*", "navIcon" -> "assets/images/teenyicons/outline-white/clipboard-tick.svg",
      ...
      "navLabel" -> "Phase Plan", "routeUrl" -> "/private/phase-plan", "toolTipLabel" -> "Phase Plan"),
    ...
    Map("access" -> "*", "navIcon" -> "assets/images/teenyicons/outline-white/bag.svg",
      ...
      "navLabel" -> "Activities", "routeUrl" -> "/private/activities", "toolTipLabel" -> "Activities"),
