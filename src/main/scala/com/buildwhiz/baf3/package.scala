...
package object baf3 {
  ...
  val menuItemsList: Seq[Document] = Seq(
    ...
    Map("access" -> "*", "navIcon" -> "assets/images/teenyicons/outline-white/view-grid.svg",
      "navIconActive" -> "assets/images/teenyicons/solid-white/view-grid.svg",
      "navLabel" -> "Zone", "routeUrl" -> "/private/zone", "toolTipLabel" -> "Zone"),
