...
object DocumentCategoryRecordsRedo extends App {
  ...
  private val data =
    """{"_id": ObjectId("5869d46692982d1c34f12d10"), "category": "ArchiCAD"}
      ...
      |{"_id": ObjectId("5869d46692982d1c34f12d12"), "category": "Architecture", "subCategory" : "CD"}
      ...
      |{"_id": ObjectId("5869d46692982d1c34f12d18"), "category": "GeoTech Field Reports"}
      ...
      |{"_id": ObjectId("5869d46692982d1c34f12d20"), "category": "Special Inspection Reports"}
