...
object DateTimeUtilsTest extends App with DateTimeUtils {
  ...
  println("******************************************")
  private val utcMillis = milliseconds("2020-01-13")
  ...
  println("******************************************")
  private val refDate = milliseconds("2022-09-23")
  private val priorDate = milliseconds("2022-09-09")
  private val laterDate = milliseconds("2022-10-07")
  private val sameDate = milliseconds("2022-09-23")
