...
import com.buildwhiz.baf2.TimerDurationSet;
...
public class TestBaf2TimerDurationSet extends Mockito {
    ...
    public void setTimerDuration() throws Exception {
        ...
        parameterMap.put("duration", new String[] {"12:34:56"});
        parameterMap.put("bpmn_name", new String[] {"Phase-With-Variables-and-Timers"});
        parameterMap.put("timer_name", new String[] {"Initial Delay"});
        ...
        new TimerDurationSet().doPost(request, response);
